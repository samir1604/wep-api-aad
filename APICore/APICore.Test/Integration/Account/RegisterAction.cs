...
namespace APICore.Tests.Integration.Account
{
    public class RegisterAction
    {
        ...
        public void SuccessfullyRegisterShouldReturnCreated()
        {
            ...
            var accountService = new AccountService(new Mock<IConfiguration>().Object, new UnitOfWork(context), new Mock<IStringLocalizer<IAccountService>>().Object, new Mock<IDetectionService>().Object, StorageAccount.CreateCloudBlobClient(), null);
