...
namespace APICore.API
{
    ...
    {
        public static void ConfigureSecuritySettings(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSingleton<IAppSecuritySettings>(_ => AppSecuritySettings.ReadConfiguration(configuration));
        }
